...
$sid = $_GET['id'];
$selectquery = "SELECT * FROM `client` WHERE id = '$sid'";
...
if (isset($_POST['submit'])) {
    ...
    $updatequery = "UPDATE `client` SET `name`='$name',
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="row mb-3">
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text"  value="<?php echo $row['name']; ?>" placeholder="Client Name" name="name" > 
                                                <!-- <label for="inputEmail">Client Name</label> -->
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="text" placeholder="" name="info" value="<?php echo $row['info']; ?>"> 
                                                <!-- <label for="inputEmail">Client Info</label> -->
                                            </div>
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="inputEmail" type="file" placeholder="" name="profile" value="<?php echo $row['image']; ?>" />
