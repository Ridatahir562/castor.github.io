                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                 <a href="./update_viewnews.php?id=<?php echo $row['id'];?>"><button class="btn btn-primary">Update</button></a>

                                                <a href="delete_viewnews.php?id=<?php echo $row['id']; ?>"> <button class="btn btn-danger">Delete</button></a>
