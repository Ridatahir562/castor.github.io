                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                 <a href="./update_viewproduct.php?id=<?php echo $row['id'];?>"><button class="btn btn-primary">Update</button></a>

                                                <a href="delete_viewproduct.php?id=<?php echo $row['id']; ?>"> <button class="btn btn-danger">Delete</button></a>
