                                ...
                                <table id="datatablesSimple">
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                 <a href="./updateadmin.php?id=<?php echo $row['id'];?>"><button class="btn btn-primary">Update</button></a>

                                                <a href="deleteadmin.php?id=<?php echo $row['id']; ?>"> <button class="btn btn-danger">Delete</button></a>
