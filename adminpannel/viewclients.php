                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <img src="<?php echo "./upload/" . $row['image']; ?>" width="52px" height="52px" alt="">
                                            </td>
                                            <td>
                                                 <a href="./update_viewclient.php?id=<?php echo $row['id'];?>"><button class="btn btn-primary">Update</button></a>

                                                <a href="delete_viewclient.php?id=<?php echo $row['id']; ?>"> <button class="btn btn-danger">Delete</button></a>
