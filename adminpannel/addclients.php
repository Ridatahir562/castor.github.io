                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Add Clients</h3></div>
                                    <div class="card-body">
                                        <form method="POST"  enctype="multipart/form-data">
                                            <div class="row mb-3"> 
                                                <div class="form-floating mb-3">
                                                    <textarea class="form-control" id="inputEmail" type="text" placeholder="" name="name"> </textarea>
                                                    <label for="inputEmail">Client Name</label>
                                                </div>
                                                <div class="form-floating mb-3">
                                                    <textarea class="form-control" id="inputEmail" type="text" placeholder="" name="info"> </textarea>
                                                    <label for="inputEmail">Client Info</label>
                                                </div>
                                                    <div class="form-floating mb-3">
                                                        <input class="form-control" id="inputEmail" type="file" placeholder="" name="profile"/>
                                                        <label for="inputEmail">Client Image</label>
                                                    </div>
                                            ...
                                            <div class="mt-4 mb-0">
                                                <div class="d-grid">
                                                    <button type="submit" class="btn btn-primary btn-block" href="" name="submit">Add Client</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
...
if(isset($_POST['submit'])){
    ...
    $insertquery = "INSERT INTO `client`(`id`, `name`, `info`, `image`) VALUES
     ('','$name','$info','$filename')";
