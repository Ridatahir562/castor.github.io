                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseclients" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="./register.php">Add Client</a>
                                    <a class="nav-link" href="./usercontect.php">View Client</a>
                                </nav>
                            </div>
                                        ...
                                        <form method="POST"  enctype="multipart/form-data">
                                            <!-- <div class="row mb-3"> -->
                                                <div class="form-floating mb-3">
                                                    <textarea class="form-control" id="inputEmail" type="text" placeholder="" name="newstitle"> </textarea>
                                                    <label for="inputEmail">News Title</label>
                                                </div>
                                                <div class="form-floating mb-3">
                                                    <textarea class="form-control" id="inputEmail" type="text" placeholder="" name="newsdetail" > </textarea>
                                                    <label for="inputEmail">News Details</label>
                                                </div>
                                            ...
                                            <div class="d-grid">
                                                    <button type="submit" class="btn btn-primary btn-block" href="" name="submit">Add News</button>
                                                </div>
                                        </form>
                                    </div>
...
if(isset($_POST['submit'])){
    ...
    $insertquery = "INSERT INTO `news`(`id`, `newstitle`, `newsdetail`) VALUES
     ('','$name','$info')";
