        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">User Contect</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item active">User Contect</li>
                    </ol>
                    <div class="card mb-4">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="delete_usercontect.php?id=<?php echo $row['id']; ?>"> <button class="btn btn-danger">Delete</button></a>
