...
<body>
   ...
   <div class="container-fluid page-header img-fluid p-4"  class="col-sm-12 col-6">
        <div class="container py-5">
            ...
            <h1 class="display-3 text-white mb-3 animated slideInDown">AHU</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="./index.php">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="#">Products</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">AHU</li>
                </ol>
            </nav>
            ...
            <div class="row g-5 mx-lg-0">
                <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class=" img-fluid h-80 w-100"  src="img/Products/AHU.webp"  alt="">
                    </div>
                </div>
                <div class="col-lg-6 about-text wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="text-primary text-uppercase mb-3">AHU</h6>
                    <h1 class="mb-5">Quick Services and Logistics Solutions</h1>
                    <p class="">The air handling unit (AHU) is the heart of central air conditioning. It collects outside air and room air, removes dust and other particles from the collected air, adjusts the temperature and humidity and then supplies comfortable and refreshing air-condit ioned air into the rooms through ducts.
                    </p>
        ...
        <div class="row pb-3">
            <div class="col-md-6 col-lg-4 mb-4 ">
                <div class="card mb-2 p-3 ">
                    <img class="card-img-top" src="img/Products/AHU.webp" alt="" height="200px" width="100px">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
                    <img class="card-img-top" src="./img/ahu/AHU1.jpg" alt="" height="200px" width="100px">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
                    <img class="card-img-top" src="./img/ahu/AHU2.jpg" alt="" height="200px" width="100px">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
                    <img class="card-img-top" src="./img/ahu/AHU3.jpg" alt="" height="200px" width="100px">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
                    <img class="card-img-top" src="./img/ahu/AHU4.jpg" alt="" height="200px" width="100px">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
                    <img class="card-img-top" src="./img/ahu/AHU5.jpg" alt="" height="200px" width="100px">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-5">An air handling unit (“AHU”) is a standard piece of equipment that you’ll see in large and small industrial or commercial spaces. They are responsible for providing fresh air to different areas of the building. Being the heart of the larger HVAC system (heating, ventilating, and air conditioning), the AHU manages ventilation by collecting outdoor air and room air (air already present in the building), filtering the air, adjusting the temperature and humidity, and then distributing a comfortable and refreshing supply of air-conditioning through ductwork inside the rooms of the building.</p>
