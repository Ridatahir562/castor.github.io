...
<body>
    ...
    <div class="container-fluid page-header img-fluid p-4" class="col-sm-12 col-6">
        <div class="container py-5">
            ...
            <h1 class="display-3 text-white mb-3 animated slideInDown">FAHU</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="./index.php">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="#">Products</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">FAHU</li>
                </ol>
            </nav>
        ...
        <div class="row pb-3">
            <div class="col-md-6 col-lg-4 mb-4 ">
                <div class="card mb-2 p-3 ">
                    <img class="card-img-top" src="img/Products/FAHU.jpeg" alt="" height="200px" width="100px">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
                    <img class="card-img-top" src="./img/fahu/FAHU1.jpg" alt="" height="200px" width="100px">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
                    <img class="card-img-top" src="./img/fahu/FAHU 2.jpg" alt="" height="200px" width="100px">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
            ...
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
                    <img class="card-img-top" src="./img/fahu/FAHU 6.jpg" alt="" height="200px" width="100px">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
                    <img class="card-img-top" src="./img/fahu/FAHU5.jpg" alt="" height="200px" width="100px">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-5">The air handler is normally constructed around a framing system with metal infill panels as required to suit the configuration of the components. In its simplest form the frame may be made from metal channels or sections, with single skin metal infill panels. The metalwork is normally galvanized for long term protection. For outdoor units some form of weatherproof lid and additional sealing around joints is provided. Larger air handlers will be manufactured from a square section steel framing system with double skinned and insulated infill panels. Such constructions reduce heat loss or heat gain from the air handler, as well as providing</p>
