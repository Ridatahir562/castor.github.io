...
<body>
    ...
    <div class="container-fluid page-header img-fluid p-4" class="col-sm-12 col-6">
        <div class="container py-5">
            ...
            <h1 class="display-3 text-white mb-3 animated slideInDown">Kitchen Hoods</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="#">Products</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Kitchen Hoods</li>
                </ol>
            </nav>
    ...
    <div class="container pt-5">
        <div class="d-flex flex-column text-center mb-5 wow fadeInUp" data-wow-delay="0.1s">
            <h1 class="mb-3" style="color: darkblue;">Kitchen Hood services</h1>
            <!-- <h1 class="m-0">Officers</h1> -->
        </div>
        <div class="row pb-3">
            <div class="col-md-6 col-lg-4 mb-4 ">
                <div class="card mb-2 p-3 ">
                    <img class="card-img-top" src="./img/kitchenhood/photo 2.jpeg" alt="" height="200px" width="100px">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
