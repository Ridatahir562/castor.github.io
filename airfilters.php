...
<body>
    ...
    <div class="container-fluid page-header img-fluid p-4" class="col-sm-12 col-6">
        <div class="container py-5">
            ...
            <h1 class="display-3 text-white mb-3 animated slideInDown">Air Filter</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a class="text-white" href="#">Home</a></li>
                    <li class="breadcrumb-item"><a class="text-white" href="#">Products</a></li>
                    <li class="breadcrumb-item text-white active" aria-current="page">Air Filters</li>
                </ol>
            </nav>
        ...
        <div class="row pb-3">
            <div class="col-md-6 col-lg-4 mb-4 ">
                <div class="card mb-2 p-3 ">
                    <img class="card-img-top" src="./img/Products/air filter.jpg" alt="" height="200px" width="100px">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
                    <img class="card-img-top" src="./img/water tank filter/t1.jpeg" alt="" height="200px" width="100px">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
                    <img class="card-img-top" src="./img/water tank filter/t2.jpeg" alt="" height="200px" width="100px">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
                    <img class="card-img-top" src="./img/water tank filter/t3.jpeg" alt="" height="200px" width="100px">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
                    <img class="card-img-top" src="./img/water tank filter/t4.jpeg" alt="" height="200px" width="100px">
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="card mb-2 p-3">
                    <img class="card-img-top" src="./img/water tank filter/t5.jpeg" alt="" height="200px" width="100px">
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.1s">
                    ...
                    <p class="mb-5">Air filters are used in applications where air quality is important, notably in building ventilation systems and in engines. The overall unit (filter and housing together) is called the air cleaner.
