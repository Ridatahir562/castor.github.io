...
<body>
        ...
        <div class="container py-5">
            ...
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-white active" aria-current="page">Partner</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-fluid overflow-hidden p-2 px-lg-0">
        ...
        <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                <h6 class="text-primary  text-uppercase">Our Partner</h6>
                <h1 class="mb-5 " style="color:darkblue">Explore Our Partner</h1>
            </div>
            <div class="row g-5 mx-lg-0">
                <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                    <div class="position-relative h-100">
                        <img class=" img-fluid h-100 w-100"  src="img/partner/umw.jpeg"  alt="">
                    </div>
                </div>
                <div class="col-lg-6 about-text wow fadeInUp" data-wow-delay="0.3s">
                    <h6 class="text-primary text-uppercase mb-3">Partner</h6>
                    <h1 class="mb-5">Quick Services and Logistics Solutions</h1>
                    <p class="mb-5">United Metal Works (UMW) established is one of the leading and reputable fabrication companies located at industrial area, Ajman UAE.
                        Our State of the art fabrication facility, combained with a dedicated team of engineers, techniciansand and management ensures on time delivery of top quality products to F&B, Petro Chemical and Infrastructure sectors.
                    </p>
